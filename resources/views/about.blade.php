<x-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">About Library Management System</h1>
            ...
            <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                ...
                At the Library Management System, we provide a rich and diverse collection of books, ensuring that every book lover finds something to enjoy. Our platform is designed to foster a sense of community among readers who share a passion for literature.                </p>
                <p class="mb-6 text-lg font-medium text-gray-700 dark:text-gray-300">
                We also encourage active participation within our community. Members have opportunities to engage in various activities, such as book discussions, reading challenges, and volunteer opportunities that enhance the Library Management System experience for everyone                <p class="mb-6 text-lg font-medium text-gray-700 dark:text-gray-300">
                ...
                <p class="mb-6 text-lg font-medium text-gray-700 dark:text-gray-300">
                The Library Management System is dedicated to providing a seamless and enriching experience for book lovers everywhere. Join us today and become part of a community that celebrates the joy of reading                </p>
                <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="https://t.me/A_Cole24" target="_blank" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Join Our Telegram
